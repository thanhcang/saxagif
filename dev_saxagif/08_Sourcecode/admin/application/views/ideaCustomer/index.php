    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-list"></i> ý kiến khách hàng</h2>
            </div>
            <div class="box-content">
                ...
                <div class="pull-left">
                    <a href="<?php echo base_url('ideaCustomer/add') ?>" class="button"><?php echo $this->lang->line('CREATE') ?></a>
                </div>
                <div class="clearfix"></div>
                ...
                <table class="table table-bordered table-striped responsive martopten datatable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th><?php echo 'Ý kiến khách hàng' ?></th>
                            <th>&nbsp;</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars_decode($value['idea']) ?></td>
                            <td>
                                ...
                                <a href="<?php echo base_url('ideaCustomer/edit/' . $value['id']) ?>" class="btn btn-info" title="Sửa"><i class="glyphicon glyphicon-edit icon-white"></i><?php echo $this->lang->line('EDIT') ?></a>
