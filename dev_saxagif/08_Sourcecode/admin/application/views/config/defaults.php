<?php //$this->load->view('adminit/common/header'); ?>
<?php //$this->load->view('adminit/common/menu'); ?>
<tr>
    <td valign="top">
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="5%" height="67" class="item_menu_left">
                                            <a href="<?php echo base_url(); ?>adminit/system/config">
                                            	<img src="<?php echo base_url(); ?>public/templates/admin/images/item_config.gif" border="0" />
                                            </a>
                                        </td>
                                        <td width="40%" height="67" class="item_menu_middle"><?php echo $this->lang->line('title_defaults'); ?></td>
                                        <td width="55%" height="67" class="item_menu_right">
                                            <div class="icon_item" id="icon_item_1" onclick="ActionLink('<?php echo base_url() ?>adminit')" onmouseover="ChangeStyleIconItem('icon_item_1',1)" onmouseout="ChangeStyleIconItem('icon_item_1',2)">
                                                <table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td align="center">
                                                            <img src="<?php echo base_url(); ?>public/templates/admin/images/icon_reset.png" border="0" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <div class="icon_item" id="icon_item_2" onclick="CheckInput_Config()" onmouseover="ChangeStyleIconItem('icon_item_2',1)" onmouseout="ChangeStyleIconItem('icon_item_2',2)">
                                                <table width="100%" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td align="center">
                                                            <img src="<?php echo base_url(); ?>public/templates/admin/images/icon_save.png" border="0" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" valign="top">
                                            ...
                                            <table width="780" class="config_main" cellpadding="0" cellspacing="0" border="0">
                                                ...
                                                <?php if($exist_file == true){ ?>
                                                <?php if($is_writable == false){ ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    <img src="<?php echo base_url(); ?>public/templates/admin/images/phone_1.gif" border="0" />
                                                                    ...
                                                                    <b>-</b>
                                                                    <img src="<?php echo base_url(); ?>public/templates/admin/images/mobile_1.gif" border="0" />
                                                                    ...
                                                                    <img src="<?php echo base_url(); ?>public/templates/admin/images/help_post.gif" class="img_helppost" onmouseover="ddrivetip('<?php echo $this->lang->line('phone_tip_help'); ?>',135,'#F0F8FF');" onmouseout="hideddrivetip();" />
...
<?php //$this->load->view('adminit/common/footer'); ?>