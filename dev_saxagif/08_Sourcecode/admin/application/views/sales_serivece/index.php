    ...
    <div class="box col-md-8">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-list"></i> Các salse phục vụ bạn</h2>
            </div>
            <div class="box-content">
                ...
                <div class="pull-left">
                    <a href="<?php echo base_url('salesService/add') ?>" class="button"><?php echo $this->lang->line('CREATE') ?></a>
                </div>
                <div class="clearfix"></div>
                ...
                <table class="table table-bordered table-striped responsive martopten datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars_decode($value['phone']) ?></td>
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url('salesService/edit/' . $value['id']) ?>" class="btn btn-info" title="Sửa"><i class="glyphicon glyphicon-edit icon-white"></i><?php echo $this->lang->line('EDIT') ?></a>
