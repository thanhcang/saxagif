    ...
    <div class="box col-md-8">
        <div class="box-inner">
            ...
            <div class="box-content">
                <form method="POST" action="<?php echo base_url('listenThemSay/add'); ?>" enctype="multipart/form-data">
                    <?php if (!empty($error)): ?>
                        <div class="error">
                            <ul>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="comment" placeholder="Nhập những gì họ nói" class="form-control" name="comment"><?php if (!empty($params['comment'])) echo html_escape($params['comment']) ?></textarea>
                    </div>
