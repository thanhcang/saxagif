    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
                <div class="pull-left">
                    <form class="frmFilter" name="frmFilter" method="GET" action="<?php echo base_url('news_saxa_everyday') ?>">
                ...
                <div class="pull-right">
                    <a href="<?php echo base_url('news_saxa_everyday/add') ?>" class="button"><?php echo $this->lang->line('CREATE') ?></a>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr class="news_<?php echo $news['id'] ?>">
                            ...
                            <td class="text-center">
                                <a class="btn btn-success" href="<?php echo base_url('news_saxa_everyday/detail/' . $news['id'] ) ?>">
                                    <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                                    <?php echo $this->lang->line('VIEW') ?>
                                </a>
                                <a class="btn btn-info" href="<?php echo base_url('news_saxa_everyday/edit/' . $news['id'] ) ?>">
