            ...
            <div class="box-content">
                <form name="frmProduct" id="frmProduct" method="POST" action="">
                    <div class="form-group">
                        ...
                        <input type="text" name="product_code" id="code" class="form-control" id="inputID" value="<?php echo htmlspecialchars($detailPro['product_code']) ?>" disabled>
                    </div>
                    <div class="form-group">
                        <label for="name"><?php echo $this->lang->line('PRO_NAME') ?></label>
                        <input type="text" name="name" id="name" class="form-control" value="<?php echo htmlspecialchars($detailPro['name']) ?>" disabled>
                    </div>
                    <div class="form-group">
                        <label for="slug"><?php echo $this->lang->line('SLUG') ?></label>
                        <input type="text" name="slug" id="slug" class="form-control" value="<?php if(!empty($detailPro['slug'])) echo htmlspecialchars($detailPro['slug']) ?>" disabled>
                    </div>
                    <div class="form-group">
                        <label for="inputPrice"><?php echo $this->lang->line('PRO_PRICE') ?></label>
                        <input type="text" name="price" id="price" class="form-control" value="<?php if(!empty($detailPro['price'])) echo trim($detailPro['price']) ?>" disabled>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="elivery_days" class="form-control" value="<?php if (!empty($detailPro['delivery_days'])) echo htmlspecialchars($detailPro['delivery_days']) ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <a href="<?php echo base_url('product/edit/' . $detailPro['id']) ?>" class="button"><?php echo $this->lang->line('EDIT') ?></a>
