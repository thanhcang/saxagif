...
/**
 *  control height category 
 */
$(document).on('click', '.showImageThumb', function(){
    var logo = $(this).attr('attr-logo');
    $('.product_large').attr('src',BASE_URL+URL_PRODUCT_THUMB_IMAGE+logo);
});