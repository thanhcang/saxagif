                ...
                <?php foreach ($cat_gift as $key => $gift): $mask = $key + 1; ?>
                    <li class="<?php if ($key == 1) echo 'last' ?>">
                        <a href="<?php echo base_url('giup-ban-chon-qua' . '/' . $gift['slug']) ?>">
                            ...
                            <div id="mask<?php echo $mask ?>" class="mask" style="background:<?php
                            if (!empty($gift['bg_color']))
                                echo $gift['bg_color'];
                            else
                                echo '#000'
                                ?>;" onmouseout="hideMask('<?php echo 'mask' . $mask ?>')">  
    ...
    <div class="our_work" id="slider3_container" style="position: relative; top: 0px; left: 0px; width: 656px; height: 219px; ">
        ...
        <?php if (!empty($articleFooter)): ?>
            <div class="content_our_work">
                <div id="slider3_container" style="position: relative; top: 0px; left: 0px; width: 656px; height: 209px; ">
                    <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width:656px; height: 209px; overflow: hidden;">
