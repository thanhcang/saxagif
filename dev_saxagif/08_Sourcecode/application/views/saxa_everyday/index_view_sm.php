...
<div class="content_boder">
    ...
    <div id="tabs">
        <ul  class="tab_menu">
            <li><a href="#tabs-1">cá nhân</a></li><!--
            <li><a href="#tabs-2">Tương tác</a></li><!--
            --><li><a href="#tabs-3">làm việc</a></li>
        </ul>
        ...
        <div class="tab-content">
            <div id="tabs-1" class="tab">
                ...
                <div class="cont_tab">
                    <div class="img_tab"><a href="chi-tiet-bai-viet.html"><img src="images/pic_2p.png"/></a></div>
                    <div class="main_tab">
                        <label><a href="chi-tiet-bai-viet.html" class="js__p_start">Bài viết 1</a></label>
                        <div class="des_tab">
